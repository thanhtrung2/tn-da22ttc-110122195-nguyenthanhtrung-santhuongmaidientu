...
const getCart = async (req, res) => {
    try {
        const [rows] = await pool.query(
            ...
            bt.id as bien_the_id, bt.mau_sac, bt.ma_mau, bt.kich_thuoc, bt.gia_them, bt.hinh_anh as variant_image, bt.so_luong_ton as variant_stock,
        ...
        rows.forEach(item => {
            ...
            grouped[item.gian_hang_id].items.push({
                ...
                ten_bien_the,
                hinh_anh: item.variant_image || item.hinh_anh
            });
        });
