...
router.delete('/cancel-unpaid/:id', authenticate, cancelUnpaidOrder);
router.post('/retry-payment/:id', authenticate, retryPayment);
router.post('/:id/rebuy', authenticate, rebuyOrder);
