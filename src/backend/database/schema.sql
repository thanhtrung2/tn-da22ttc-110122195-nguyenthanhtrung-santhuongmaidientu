...
CREATE TABLE IF NOT EXISTS san_pham (
    ...
    thuoc_tinh JSON,
    trang_thai ENUM('active', 'inactive', 'banned', 'deleted') DEFAULT 'active',
...
CREATE TABLE IF NOT EXISTS thong_bao (
    ...
    noi_dung TEXT NOT NULL,
    loai ENUM('system', 'order', 'payment', 'product', 'complaint', 'chat', 'voucher', 'review', 'shop', 'seller_registration', 'seller_registration_received', 'seller_approved', 'seller_rejected', 'promotion', 'other') DEFAULT 'system',
